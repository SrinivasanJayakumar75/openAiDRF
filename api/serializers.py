...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model =UserSerializerfields = ("id", "username", "email", "password")
        extra_kwargs = {
...
class TokenSerializer(serializers.Serializer):
    ...
    password = serializers.CharField(style={"input_type":"password"},trim_whitespaces=False)
    ...
    def validate(self, attrs):
        ...
        if not user:
            ...
            raise serializers.ValidateError(msg, code="authentication")
        attrs["user"] = user
        return attrs
